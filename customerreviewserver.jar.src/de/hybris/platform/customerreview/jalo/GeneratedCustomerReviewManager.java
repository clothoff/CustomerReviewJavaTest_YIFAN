...
/*     */   }
			...
			public abstract Integer getNumberOfReviewsWithinRange(SessionContext paramSessionContext, Product paramProduct, Double low, Double high);

			public Integer getNumberOfReviewsWithinRange(Product item, Double low, Double high){
				return getNumberOfReviews(getSession().getSessionContext(), item, low, high);
			}
/*     */   
/*     */ 
/*     */ 
